...
SHMSMagTabulatedField3D class implementation

11-01-2013 Buddhini
NOTE - Michael Moors TOSCA code for SHMS generates the field fild 
using the center of the HB as the origin.
*/
//******************************************************************
...
SHMSMagTabulatedField3D::SHMSMagTabulatedField3D( const char* filename) 
...
{    
  ...
  G4cout << " ---> assumed the order:  x, y, z, Bx, By, Bz "
	 ...
	 << "\n ---> The field will be translated by  cm " << endl;
...
void SHMSMagTabulatedField3D::GetFieldValue(const double point[4],
				      double *Bfield ) const
{
  // The coordinates used for magnetic fields in GEANT$ are all *global* coordinates.
  double x = point[0];
  double y = point[1];
